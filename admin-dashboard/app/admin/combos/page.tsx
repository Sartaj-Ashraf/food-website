...
export default function CombosAdminPage() {
  ...
  const fetchCombos = async () => {
    try {
      ...
      const response = await customFetch.get(`/combos?${params}`);
  ...
  const handleDelete = async (comboId: string) => {
    try {
      const response = await customFetch.delete(`/combos/${comboId}`);
      const data = await response.data;
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your product combo bundles and deals
          </p>
        </div>
        <div className="flex gap-2">
          <Link href="/admin/combos/deleted-combos">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Combos ({pagination.totalDocs})</CardTitle>
          <CardDescription>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <Button variant="ghost" size="sm" asChild>
                              <Link href={`/admin/combos/edit/${combo._id}`}>
